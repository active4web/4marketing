...
<body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo page-md">
								...
								<span class="portlet-body">
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
										...
										$image=$data->img;
												...
												$id_course=get_table_filed('soical_advertising',array('id'=>$id_order),"adversiting_id");;
												$course_name = get_table_filed('products',array('id'=>$id_course,'view'=>'1'),"name");
												$final_price = get_table_filed('soical_advertising',array('id'=>$id_order),"price");
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
  ...
  <td> <a href="<?= base_url()?>admin/courses/courses_details?id=<?= $id_course?>"><?=mb_substr($course_name,0,50);?></a> </td>
												<td>
