...
<div class="row">
	<div class="col-md-12">
		...
		<input type="radio"  <?php 	if($status==2){?>disabled<?php }?> <?php if($status==1){?>checked<?php }?>  class="form-control" style="height:22px;" name="status" value="1" >تأكيد طلب  بنجاح         
		<input type="radio" <?php 	if($status==1){?>disabled<?php }?> <?php if($status==2){?>checked<?php }?>   class="form-control main_title" style="height:22px;" name="status" value="2" >  رفض  الطلب
										</div>
										<div class="col-md-1"></div>
									</div>
