			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">الباقات</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">الباقات</span>
									</div>
								</div>
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
									   ...
									   ?>
											<tr class="odd gradeX">
												...
												<td> <?=$data->time_days;?> </td>
												<td> <?=$data->price;?> </td>
												<td><a title="view image" class="example-image-link" href="<?= base_url('')?>uploads/icon/<?= $data->icon;?>" data-lightbox="example-1"><i class="fa fa-picture-o"></i> الصورة</a> </td>
												<td>
