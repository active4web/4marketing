...
<title>الأعلانات المحذوفة</title>
			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">الأعلانات المحذوفة</span>
						</li>
									...
									<td> <a href="<?=$url?>admin/users/customers_details?id=<?=$data->user_id?>"><?= mb_substr($user_name,0,50);?></a></td>
												...
												<td>
													<div class="btn-group">
														...
														<li><a href="<?=$url?>admin/courses/final_delete?id=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>

													   <li><a  class="confirm_delete"><i class="fa fa-remove"></i> استرجاع </a>
...
var data={id:id};
	...
	$(".confirm_delete").click(function(e) {
     ...
     var b=confirm("هل انت متأكدة من استرجاع الأعلان");
    if(b==true){
      window.location.assign("<?=$url?>admin/courses/restore?id_customers="+iduser);  
    }
...
$(document).ready(function(e) {
	...
	else{toastr.warning("من فضلك حدد على الاقل اعلان واحد للحذف");}
	});
});
</script>
