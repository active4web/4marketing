												...
												<div class="portlet box blue ">
													...
													<div class="portlet light bordered form-fit">
														<div class="portlet-body form">
															...
															<form action="<?php echo $url?>admin/department/add_action" class="form-horizontal form-bordered"
																...
																<div class="form-body">
																	...
																	<div class="form-group">
																		...
																		<span class="help-block"> عنوان القسم </span>
																			<input name="title" id="title"  type="text" placeholder="عنوان القسم" class="form-control" required>
