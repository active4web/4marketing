...
<li>
						...
						<li>
							<span class="active">الاقسام الفرعية</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
						...
						<div class="col-md-12">
							...
							<div class="portlet light bordered">
								...
								<span class="portlet-body">
									<div class="table-toolbar">
										...
										<div class="col-md-6">
												...
												<?php 
													?>
													<div class="btn-group">
													<button id="sample_editable_1_2_new" class="btn sbold green addbutton">إضافة قسم
									...
									<form action="<?=$url?>admin/department/delete" method="POST" id="form">
									<div>
                                        ...
                                        <?php
                                            foreach($results as $data) {
												...
												switch($view){
													...
													$category_name=	get_table_filed('category',array('id'=>$data->id_cat),"name");
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?=$url?>admin/department/details?id=<?=$data->id;?>"><i class="fa fa-eye"></i> تعديل </a></li>
															<li><a href="<?=$url?>admin/department/delete?id_notifications=<?=$data->id;?>"><i class="fa fa-remove"></i> حذف </a></li>
...
$(document).ready(function(e) {
    ...
    $(".addbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/department/add");
    });
	$(".delbutton").click(function(e) {
        window.location.assign("<?= DIR?>admin/department/delete");
	});
});
</script>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/department/check_view_department") ?>',
                type: 'POST',
                data: data,				
