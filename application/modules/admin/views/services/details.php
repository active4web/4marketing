			...
			<div class="page-content-wrapper">
				<div class="page-content" style="min-height: 1261px;">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="<?=$url.'admin/services/';?>">التصنيفات</a>
							<i class="fa fa-circle"></i>
						</li>
						<li>
											...
											<div class="tab-pane active" id="tab_5">
												<div class="portlet box blue ">
													<div class="portlet-title">
														<div class="caption">
															<i class="fa fa-gift"></i>تعديل تصنيف</div>
													</div>
													<?php //print_r($now);?>
																...
																<div class="form-body">
																	...
																	<div class="col-md-10">
																		<div class="fileinput fileinput-new" data-provides="fileinput">
																						...
																						<img src="<?=$url;?>uploads/category/<?php echo $services_type->icon?>" alt="" />
																						</div>
																						<div class="fileinput-preview fileinput-exists thumbnail" style="width: 64px;height: 64px;">
																		...
																		<p style="direction:rtl">طول الصورة 64 بيكسل</p>
																	</div>
																	<div class="col-md-1"></div>
																	</div>
