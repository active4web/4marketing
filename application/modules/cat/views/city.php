...
<div class="home-tab">
   ...
   <div class="page-title">
              <h2>
<?= 
get_table_filed('city',array('id'=>$this->input->get("ID")),"name")."(".count($result_count).")";
?>
 </h2></div>
...
?>
<span class="arrange"><a href="<?=base_url()?>cat/city?ID=<?= $this->input->get("ID");?>" style="color:#003b67db">الاحدث</a></span>
<?php } else {?><span class="arrange">الاحدث</span><?php }?>
<span>|</span>
<?php
if($this->input->get("arrange")=="low_price"||$this->input->get("arrange")==""){
?>
<span class="arrange"><a href="<?=base_url()?>cat/city?ID=<?= $this->input->get("ID");?>&arrange=heigh_price" style="color:#003b67db">الأعلى سعر</a></span>
...
?>
<span class="arrange"><a href="<?=base_url()?>cat/city?ID=<?= $this->input->get("ID");?>&arrange=low_price" style="color:#003b67db"> الأقل سعر</a></span>
<?php } else if($this->input->get("arrange")=="low_price"){?><span class="arrange"> الأقل سعر</span><?php }?>		
            ...
            <a href="<?=base_url()?>cat/city?ID=<?= $this->input->get("ID");?>&featured=no" class="adv_link">كل الأعلانات</a></span>
            <?php }else{?>
              <span style="padding:5px;font-size:16px;"><a href="<?=base_url()?>cat/city?ID=<?= $this->input->get("ID");?>&featured=yes" class="adv_link">اعلانات مميزة</a></span>
