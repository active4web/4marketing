			...
			<div class="toolbar" style="border-bottom:1px solid #8181812e">
              <div class="view-mode">
                <ul>
                  ...
                  <li > <a href="<?=base_url()?>cat/list?ID=<?= $this->input->get("ID");?>"> <i class="fa fa-th-list"></i> </a> </li>
                </ul>
              </div>
              <div class="sorter">
...
?>
<span class="arrange"><a href="<?=base_url()?>cat/grid?ID=<?= $this->input->get("ID");?>" style="color:#003b67db">الاحدث</a></span>
<?php } else {?><span class="arrange">الاحدث</span><?php }?>
<span>|</span>
<?php
if($this->input->get("arrange")=="low_price"||$this->input->get("arrange")==""){
?>
<span class="arrange"><a href="<?=base_url()?>cat/grid?ID=<?= $this->input->get("ID");?>&arrange=heigh_price" style="color:#003b67db">الأعلى سعر</a></span>
...
?>
<span class="arrange"><a href="<?=base_url()?>cat/grid?ID=<?= $this->input->get("ID");?>&arrange=low_price" style="color:#003b67db"> الأقل سعر</a></span>
