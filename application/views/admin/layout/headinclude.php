...
<head>
    ...
    <!-- radial chart.css -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/admin/pages/chart/radial/css/radial.css" type="text/css" media="all">
    <!-- Data Table Css -->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/admin/bower_components/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css">
    <!-- Style.css -->
