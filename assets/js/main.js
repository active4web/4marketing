...
$(document).ready(function(){
	var slides = [{src: 'images/visa.png'}, {src: 'images/paypal.png'}, {src: 'images/discover.png'}]
	//var jR3DCarousel;
	var carouselProps =  {
			 		  width: 50, 				/* largest allowed width */
					  height: 31, 				/* largest allowed height */
	...
	function setUp(){
 		//jR3DCarousel = $('.jR3DCarouselGallery').eq(0).jR3DCarousel(carouselProps);
	...
	$('.carousel-props input').change(function(){
		...
		for(var i = 0; i < 999; i++)
	     clearInterval(i);
		$('.jR3DCarouselGallery').eq(0).empty();
		setUp();
	...
	setUp()
	//jR3DCarousel1 = $('.jR3DCarouselGallery').eq(1).jR3DCarousel(carouselProps1);
